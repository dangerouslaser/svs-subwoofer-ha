...
SVS_PARAMS: dict[str, SVSParameter] = {
    "FULL_SETTINGS": SVSParameter(id=4, offset=0x0, limits=[None], limits_type="group", n_bytes=52, reset_id=-1),
    "DISPLAY": SVSParameter(id=4, offset=0x0, limits=[0, 1, 2], limits_type=1, n_bytes=2, reset_id=0),
    "DISPLAY_TIMEOUT": SVSParameter(id=4, offset=0x2, limits=[0, 10, 20, 30, 40, 50, 60], limits_type=1, n_bytes=2, reset_id=1),
    "STANDBY": SVSParameter(id=4, offset=0x4, limits=[0, 1, 2], limits_type=1, n_bytes=2, reset_id=2),
    "BRIGHTNESS": SVSParameter(id=4, offset=0x6, limits=[0, 1, 2, 3, 4, 5, 6, 7], limits_type=1, n_bytes=2, reset_id=14),
    "LOW_PASS_FILTER_ALL_SETTINGS": SVSParameter(id=4, offset=0x8, limits=[None], limits_type="group", n_bytes=6, reset_id=3),
    "LOW_PASS_FILTER_ENABLE": SVSParameter(id=4, offset=0x8, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=3),
    "LOW_PASS_FILTER_FREQ": SVSParameter(id=4, offset=0xa, limits=[30, 200], limits_type=0, n_bytes=2, reset_id=3),
    "LOW_PASS_FILTER_SLOPE": SVSParameter(id=4, offset=0xc, limits=[6, 12, 18, 24], limits_type=1, n_bytes=2, reset_id=3),
    "PEQ1_ALL_SETTINGS": SVSParameter(id=4, offset=0xe, limits=[None], limits_type="group", n_bytes=8, reset_id=5),
    "PEQ1_ENABLE": SVSParameter(id=4, offset=0xe, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=5),
    "PEQ1_FREQ": SVSParameter(id=4, offset=0x10, limits=[20, 200], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ1_BOOST": SVSParameter(id=4, offset=0x12, limits=[-12.0, 6.0], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ1_QFACTOR": SVSParameter(id=4, offset=0x14, limits=[0.2, 10.0], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ2_ALL_SETTINGS": SVSParameter(id=4, offset=0x16, limits=[None], limits_type="group", n_bytes=8, reset_id=5),
    "PEQ2_ENABLE": SVSParameter(id=4, offset=0x16, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=5),
    "PEQ2_FREQ": SVSParameter(id=4, offset=0x18, limits=[20, 200], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ2_BOOST": SVSParameter(id=4, offset=0x1a, limits=[-12.0, 6.0], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ2_QFACTOR": SVSParameter(id=4, offset=0x1c, limits=[0.2, 10.0], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ3_ALL_SETTINGS": SVSParameter(id=4, offset=0x1e, limits=[None], limits_type="group", n_bytes=8, reset_id=5),
    "PEQ3_ENABLE": SVSParameter(id=4, offset=0x1e, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=5),
    "PEQ3_FREQ": SVSParameter(id=4, offset=0x20, limits=[20, 200], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ3_BOOST": SVSParameter(id=4, offset=0x22, limits=[-12.0, 6.0], limits_type=0, n_bytes=2, reset_id=5),
    "PEQ3_QFACTOR": SVSParameter(id=4, offset=0x24, limits=[0.2, 10.0], limits_type=0, n_bytes=2, reset_id=5),
    "ROOM_GAIN_ALL_SETTINGS": SVSParameter(id=4, offset=0x26, limits=[None], limits_type="group", n_bytes=6, reset_id=8),
    "ROOM_GAIN_ENABLE": SVSParameter(id=4, offset=0x26, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=8),
    "ROOM_GAIN_FREQ": SVSParameter(id=4, offset=0x28, limits=[25, 31, 40], limits_type=1, n_bytes=2, reset_id=8),
    "ROOM_GAIN_SLOPE": SVSParameter(id=4, offset=0x2a, limits=[6, 12], limits_type=1, n_bytes=2, reset_id=8),
    "VOLUME": SVSParameter(id=4, offset=0x2c, limits=[-60, 0], limits_type=0, n_bytes=2, reset_id=12),
    "PHASE": SVSParameter(id=4, offset=0x2e, limits=[0, 180], limits_type=0, n_bytes=2, reset_id=9),
    "POLARITY": SVSParameter(id=4, offset=0x30, limits=[0, 1], limits_type=1, n_bytes=2, reset_id=10),
    "PORTTUNING": SVSParameter(id=4, offset=0x32, limits=[20, 30], limits_type=1, n_bytes=2, reset_id=11),
    "PRESET1NAME": SVSParameter(id=8, offset=0x0, limits=[""], limits_type=2, n_bytes=8, reset_id=13),
    "PRESET2NAME": SVSParameter(id=9, offset=0x0, limits=[""], limits_type=2, n_bytes=8, reset_id=13),
    "PRESET3NAME": SVSParameter(id=0xA, offset=0x0, limits=[""], limits_type=2, n_bytes=8, reset_id=13),
    "PRESET1LOAD": SVSParameter(id=0x18, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET2LOAD": SVSParameter(id=0x19, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET3LOAD": SVSParameter(id=0x1A, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET4LOAD": SVSParameter(id=0x1B, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET1SAVE": SVSParameter(id=0x1C, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET2SAVE": SVSParameter(id=0x1D, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
    "PRESET3SAVE": SVSParameter(id=0x1E, offset=0x1, limits=[None], limits_type=-1, n_bytes=0, reset_id=-1),
}
    ...
    if frame_type in ["MEMWRITE", "MEMREAD", "READ_RESP", "PRESETLOADSAVE"]:
        ...
        for offset in range(0, mem_size or 2, 2):
            for param_name, param_info in SVS_PARAMS.items():
                ...
                if frame_type in ["READ_RESP", "MEMWRITE"] and len(data_payload) >= param_info.n_bytes:
                    # Decode the value
                    ...
                    if param_info.limits_type == 2:
                        ...
                        value = ((-1) ** (mask % 2)) * ((raw_int - (mask % 2)) ^ mask) / 10
        ...
        if len(payload) >= 1 + sw_ver_len:
            result["VALIDATED_VALUES"]["SW_VERSION"] = payload[1:1 + sw_ver_len].decode('utf-8')
        ...
        if len(payload) >= 1 + hw_ver_len:
            result["VALIDATED_VALUES"]["HW_VERSION"] = payload[1:1 + hw_ver_len].decode('utf-8')
